...
const char* ssid = "iPhone de Guilherme Andrade"; 
const char* password = "flaamer123";
...
void loop() {
  ...
  if (currentTime.tm_min % 15 == 0 && currentTime.tm_min != lastVerifiedMinute && thereAreProgramsForToday()) {
